...
public extension AnyWorkflowConvertible {
    ...
    func rendered<Parent, Action>(in context: RenderContext<Parent>, key: String = "", outputMap: @escaping (Output) -> Action) -> Rendering where Action: WorkflowAction, Action.WorkflowType == Parent {
...
public extension AnyWorkflowConvertible where Rendering == Void {
    func running<Parent, Action>(in context: RenderContext<Parent>, key: String = "", outputMap: @escaping (Output) -> Action) where Action: WorkflowAction, Action.WorkflowType == Parent {
...
public extension AnyWorkflowConvertible where Rendering == Void, Output: WorkflowAction {
    func running<Parent>(in context: RenderContext<Parent>, key: String = "") where Parent: Workflow, Output.WorkflowType == Parent {
