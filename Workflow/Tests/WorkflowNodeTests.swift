...
extension CompositeWorkflow {
    ...
    enum Event: WorkflowAction {
        ...
        func apply(toState state: inout CompositeWorkflow<A, B>.State, context: ActionContext<WorkflowType.Props>) -> CompositeWorkflow<A, B>.Output? {
            switch self {
...
extension EventEmittingWorkflow {
    ...
    enum Event: Equatable, WorkflowAction {
        ...
        func apply(toState state: inout EventEmittingWorkflow.State, context: ActionContext<WorkflowType.Props>) -> EventEmittingWorkflow.Output? {
            switch self {
            case .tapped:
                .helloWorld
            }
