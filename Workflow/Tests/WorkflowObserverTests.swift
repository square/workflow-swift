...
private final class TestObserver: WorkflowObserver {
    ...
    func workflowDidReceiveAction<Action: WorkflowActionBase>(_ action: Action, workflow: Action.WorkflowType, session: WorkflowSession) {
        onDidReceiveAction?(action, workflow, session)
    }

    func workflowWillApplyAction<Action: WorkflowActionBase>(_ action: Action, workflow: Action.WorkflowType, state: Action.WorkflowType.State, session: WorkflowSession) -> ((Action.WorkflowType.State, Action.WorkflowType.Output?) -> Void)? {
