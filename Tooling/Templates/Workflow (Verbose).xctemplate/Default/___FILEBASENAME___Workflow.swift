...
extension ___VARIABLE_productName___Workflow {
    enum Action: WorkflowAction {
        ...
        func apply(toState state: inout ___VARIABLE_productName___Workflow.State, context: ActionContext<WorkflowType.Props>) -> ___VARIABLE_productName___Workflow.Output? {
            switch self {
