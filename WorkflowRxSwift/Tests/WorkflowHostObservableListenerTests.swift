...
class WorkflowHostObservableListenerTests: XCTestCase {
    func test_addingObservableRenderingListener() {
        ...
        let subscription = host.renderingObservable.subscribe(onNext: { rendering in
