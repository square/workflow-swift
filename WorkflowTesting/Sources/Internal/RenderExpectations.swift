 ...
 */
    ...
    extension RenderTester {
        class ExpectedSideEffect<WorkflowType: Workflow> {
            let key: AnyHashable
            let file: StaticString
            let line: UInt
        ...
        final class ExpectedSideEffectWithAction<WorkflowType, ActionType: WorkflowAction>: ExpectedSideEffect<WorkflowType> where ActionType.WorkflowType == WorkflowType {
