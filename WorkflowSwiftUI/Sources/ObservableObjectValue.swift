...
@dynamicMemberLookup
public final class ObservableObjectValue<Value>: ObservableObject {
    ...
    ) -> (ObservableObjectValue, Sink<Value>) {
        let observableValue = ObservableObjectValue(value: value, isDuplicate: isDuplicate)
    ...
    public func scope<LocalValue>(_ toLocalValue: @escaping (Value) -> LocalValue, isDuplicate: ((LocalValue, LocalValue) -> Bool)? = nil) -> ObservableObjectValue<LocalValue> {
    ...
    /// - Returns: a scoped ObservableValue of LocalValue.
    public func scope<LocalValue>(_ toLocalValue: @escaping (Value) -> LocalValue) -> ObservableObjectValue<LocalValue> where LocalValue: Equatable {
    ...
    private func scopeToLocalValue<LocalValue>(_ toLocalValue: @escaping (Value) -> LocalValue, isDuplicate: ((LocalValue, LocalValue) -> Bool)? = nil) -> ObservableObjectValue<LocalValue> {
        let localObservableValue = ObservableObjectValue<LocalValue>(
